...
> [!IMPORTANT]
> You will need an arm64 image for most phones. To build an arm64 image on a x86_64 system, run `export CROSS_SYSTEM=aarch64-linux` before running nix-build
>
